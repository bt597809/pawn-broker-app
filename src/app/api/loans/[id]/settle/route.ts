...
import { parseDate, settleSchema } from "@/lib/validation";
...
export async function POST(
  ...
  try {
    ...
    const parsed = settleSchema.parse(await request.json());
    const details = await paymentService.settleLoan(loanId, {
